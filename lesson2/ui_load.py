...
from PyQt5.QtWidgets import QLineEdit, QPushButton, QVBoxLayout, QHBoxLayout, QAction, qApp
...
class AgeWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle('Occupation prediction based on occupation check')
    ...
    def check_age(self):
        ...
        age_message_tuple = ({'age': 7, 'message': "Where are your parents kid?"},
                       ...
                       {'age': 23 , 'message': "Why aren't you in school?"},
                       {'age': 65 , 'message': "Why aren't you in school?"},
